...
def convert_temperature(temperature, temperatureType):
...
def basicCalculator(num1, num2, typeOp):
    if(typeOp.lower() == 'subtract'):
        return num1 - num2
    elif(typeOp.lower() == 'add'):
        return num1 + num2
    elif(typeOp.lower() == 'multiply'):
        return num1 * num2
    elif(typeOp.lower() == 'divide'):
        return num1 / num2
    else:
